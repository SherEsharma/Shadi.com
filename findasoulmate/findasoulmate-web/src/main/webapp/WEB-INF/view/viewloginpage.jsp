						...
						<div class="header-left-bottom">
							...
							<form:form class="form-horizontal" id="myform"
								...
								<form:input class="user active" id="adminEmail"
									required="required" placeholder="Enter email" path="useremail" maxlength="50"/>
								<form:errors path="useremail" cssClass="error-msg" />
								
								
								<form:password path="userPassword" class="lock active" id="pwd"
									required="required" placeholder="Enter password" maxlength="50"/>
								<form:errors path="userPassword" cssClass="error-msg" />
								<input type="submit" value="Login">
							</form:form>
							
							<a href="">Forgotten account?</a>
							<span role="presentation" aria-hidden="true"> · </span>
							<a href="">Sign up for Shadi</a>
						</div>
					</div>
					<div class="clear"></div>
				</div>
